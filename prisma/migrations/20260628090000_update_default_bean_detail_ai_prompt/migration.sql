-- Update existing default Bean Detail AI prompt to the latest source-priority prompt.
...
Return text facts only: origin, process, roast level, flavor notes, source URL, and confirmed notes.$bean_prompt$,
